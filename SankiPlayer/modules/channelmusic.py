...
from SankiPlayer.modules.play import generate_cover
from SankiPlayer.modules.play import arq
from SankiPlayer.modules.play import cb_admin_check
from SankiPlayer.modules.play import transcode
from SankiPlayer.modules.play import convert_seconds
from SankiPlayer.modules.play import time_to_seconds
from SankiPlayer.modules.play import changeImageSize
from SankiPlayer.config import BOT_NAME as bn
from SankiPlayer.config import DURATION_LIMIT
from SankiPlayer.config import UPDATES_CHANNEL as updateschannel
from SankiPlayer.config import que
from SankiPlayer.function.admins import admins as a
from SankiPlayer.helpers.errors import DurationLimitError
from SankiPlayer.helpers.decorators import errors
from SankiPlayer.helpers.admins import get_administrators
from SankiPlayer.helpers.channelmusic import get_chat_id
from SankiPlayer.helpers.decorators import authorized_users_only
from SankiPlayer.helpers.filters import command, other_filters
from SankiPlayer.helpers.gets import get_file_name
from SankiPlayer.services.callsmusic import callsmusic, queues
from SankiPlayer.services.callsmusic.callsmusic import client as USER
from SankiPlayer.services.converter.converter import convert
from SankiPlayer.services.downloaders import youtube
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/85bc63570c1322144b1e1.jpg"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @SankiPlayerBot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/85bc63570c1322144b1e1.jpg"
